...
module.exports = function($, _) {
  ...
  var designer;
  var inApp = Webflow.env();
  var overlay = '<div class="w-nav-overlay" data-wf-ignore ></div>';
  var namespace = '.w-nav';
...
module.exports = function($, _) {
  ...
  var dot = '<div class="w-slider-dot" data-wf-ignore ></div>';
  var ix = Webflow.ixEvents();
  var fallback;
  var redraw;
...
Webflow.require('ix').init([
  ...
  {"slug":"show-toggle-menus","name":"show toggle menus","value":{"style":{},"triggers":[{"type":"click","selector":".togglemenu","stepsA":[{"display":"block","opacity":0.99,"wait":200,"transition":"opacity 400ms ease 0ms"}],"stepsB":[{"display":"none","opacity":0,"wait":200,"transition":"transform 400ms ease 0ms, opacity 400ms ease 0ms"}]}]}},
